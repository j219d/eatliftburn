    ...
    return (
      <>
        ...
        <div style={{ padding:"24px", paddingTop:"58px", paddingBottom:"80px", fontFamily:"Inter, Arial, sans-serif", maxWidth:"500px", margin:"auto"}}>
          ...
          <label>Protein (g): <input type="number" inputMode="decimal" min="0" value={cutProtein} onChange={e => setCutProtein(parseFloat(e.target.value)||0)}  pattern="[0-9]*[.,]?[0-9]*" step="0.01" style={{ width:"80px" }} /></label>
          <label>Fat (g): <input type="number" inputMode="decimal" min="0" value={cutFat} onChange={e => setCutFat(parseFloat(e.target.value)||0)}  pattern="[0-9]*[.,]?[0-9]*" step="0.01" style={{ width:"80px" }} /></label>
          <label>Carbs (g): <input type="number" inputMode="decimal" min="0" value={cutCarb} onChange={e => setCutCarb(parseFloat(e.target.value)||0)}  pattern="[0-9]*[.,]?[0-9]*" step="0.01" style={{ width:"80px" }} /></label>
          </div>

          <h2>🧰 Maintenance Macros</h2>
          <div style={{ display:"flex", gap:"12px", alignItems:"center", flexWrap:"wrap", marginTop:"8px" }}>
          <label>Protein (g): <input type="number" inputMode="decimal" min="0" value={maintProtein} onChange={e => setMaintProtein(parseFloat(e.target.value)||0)}  pattern="[0-9]*[.,]?[0-9]*" step="0.01" style={{ width:"80px" }} /></label>
          <label>Fat (g): <input type="number" inputMode="decimal" min="0" value={maintFat} onChange={e => setMaintFat(parseFloat(e.target.value)||0)}  pattern="[0-9]*[.,]?[0-9]*" step="0.01" style={{ width:"80px" }} /></label>
          <label>Carbs (g): <input type="number" inputMode="decimal" min="0" value={maintCarb} onChange={e => setMaintCarb(parseFloat(e.target.value)||0)}  pattern="[0-9]*[.,]?[0-9]*" step="0.01" style={{ width:"80px" }} /></label>
          </div>

          <h2>🍚 Bulk Macros</h2>
          <div style={{ display:"flex", gap:"12px", alignItems:"center", flexWrap:"wrap", marginTop:"8px" }}>
          <label>Protein (g): <input type="number" inputMode="decimal" min="0" value={bulkProtein} onChange={e => setBulkProtein(parseFloat(e.target.value)||0)}  pattern="[0-9]*[.,]?[0-9]*" step="0.01" style={{ width:"80px" }} /></label>
          <label>Fat (g): <input type="number" inputMode="decimal" min="0" value={bulkFat} onChange={e => setBulkFat(parseFloat(e.target.value)||0)}  pattern="[0-9]*[.,]?[0-9]*" step="0.01" style={{ width:"80px" }} /></label>
          <label>Carbs (g): <input type="number" inputMode="decimal" min="0" value={bulkCarb} onChange={e => setBulkCarb(parseFloat(e.target.value)||0)}  pattern="[0-9]*[.,]?[0-9]*" step="0.01" style={{ width:"80px" }} /></label>
          </div>
        </div>
