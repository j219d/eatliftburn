...
const foodOptions = [
  ...
  { name: "Blueberries (half cup)", cal: 42, prot: 0.5, fat: 0.3, carbs: 10.5, fiber: 1.8 },
  { name: "Blueberries (1 cup)", cal: 84, prot: 1, fat: 0.5, carbs: 21, fiber: 3.6 },
  ...
  { name: "Chia pudding (almond milk + chia)", cal: 83, prot: 2.5, fat: 6, carbs: 11, fiber: 10 },
  { name: "Chia seeds (1 tbsp)", cal: 60, prot: 2, fat: 4, carbs: 11, fiber: 10 },
  ...
  { name: "Strawberries (half cup)", cal: 25, prot: 0.5, fat: 0.2, carbs: 6, fiber: 1.5 },
  { name: "Strawberries (1 cup)", cal: 49, prot: 1, fat: 0.5, carbs: 12, fiber: 3 },
